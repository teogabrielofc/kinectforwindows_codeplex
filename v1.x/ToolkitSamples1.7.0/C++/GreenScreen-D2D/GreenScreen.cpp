...
/// </summary>
void CALLBACK CGreenScreen::StatusChangeCallback(HRESULT hrStatus, const OLECHAR* instancename, const OLECHAR* uniqueDeviceName, void* pUserData)
{
...
/// </summary>
void CGreenScreen::UpdateSensorAndStatus(DWORD changedFlags)
{
    switch(changedFlags)
    {
...
/// </summary>
void CGreenScreen::UpdateNscControlStatus()
{
