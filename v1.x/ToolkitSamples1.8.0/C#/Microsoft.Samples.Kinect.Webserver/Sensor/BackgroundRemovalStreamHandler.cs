...
namespace Microsoft.Samples.Kinect.Webserver.Sensor
{
    ...
    public class BackgroundRemovalStreamHandler : SensorStreamHandlerBase
    {
        ...
        /// </summary>
        private int trackingId = SharedConstants.InvalidUserTrackingId;
        ...
        public override void OnSensorChanged(KinectSensor newSensor)
        {
            if (this.sensor != null)
            {
                try
                {
                    ...
                    this.trackingId = SharedConstants.InvalidUserTrackingId;
                    ...
                    case TrackingIdPropertyName:
                        {
                            ...
                            if ((this.backgroundRemovalStream != null) && (this.trackingId != oldTrackingId))
                            {
